...
Options:
      ...
      --r1cs-reduce-entries <REDUCE_ENTRIES>
          Attempt to reduce the number of matrix entries by collapsing big LCs
          
          [env: R1CS_REDUCE_ENTRIES=]
          [default: true]
          [possible values: true, false]
...
Options:
      ...
      --r1cs-reduce-entries <REDUCE_ENTRIES>
          Attempt to reduce the number of matrix entries by collapsing big LCs [env: R1CS_REDUCE_ENTRIES=] [default: true] [possible values: true, false]
      --r1cs-div-by-zero <DIV_BY_ZERO>

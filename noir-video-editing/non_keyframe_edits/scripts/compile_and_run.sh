...
bb write_vk -b ./target/non_keyframe_edits.json -o ./target

echo -e "\033[0;32m===== Generating Gate Counts =====\033[0m"
# Generate gate count
bb gates -b ./target/non_keyframe_edits.json

echo -e "\033[0;32m===== Timing Proof Generation =====\033[0m"
# Actually compute the proof
time bb prove -b ./target/non_keyframe_edits.json -w ./target/non_keyframe_edits.gz -o ./target --vk_path ./target/vk

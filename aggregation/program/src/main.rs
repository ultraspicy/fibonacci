...
/// Encode a list of vkeys and committed values into a single byte array. 
/// In the future this could be a merkle tree or some other commitment scheme.
///
...
pub fn main() {
    ...
    // For quick verification, the public value is the sum over each pixel
